...
'''epochs = [10, 20, 30]
batch_size = [2, 4, 8, 16, 32]
learning_rate = [5e-7, 1e-7, 5e-8, 1e-8, 5e-9, 1e-9, 5e-10, 1e-10, 5e-11, 1e-11, 5e-12, 1e-12]
'''
...
print(f"BEST RESULTS FOR CONCRETE DATASET: Epochs {best_results['epochs']}, batch size {best_results['batch_size']}, and lr {best_results['learning_rate']}")
